...
export default function Footer({ onNavigate, onToggleDashboard, showDashboard, onBookVisit }: FooterProps) {
  ...
  return (
    <footer className="bg-[#1B4332] text-white/90 relative overflow-hidden">
      
      {/* Premium Trust Signals Strip */}
      <div className="border-b border-white/[0.08] bg-[#173728] py-8 mb-12">
        <div className="max-w-7xl mx-auto px-6 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
            ...
            <div className="group flex items-center gap-3.5 justify-start cursor-pointer transition-all duration-250 ease-out md:hover:-translate-y-[2px] md:hover:bg-white/2 p-2 rounded-2xl md:hover:shadow-[0_8px_24px_-8px_rgba(0,0,0,0.15)]">
              <span className="p-2.5 rounded-xl bg-[#2D6A4F]/20 text-[#D4AF37] shrink-0 border border-white/[0.08] transition-all duration-250 ease-out group-hover:bg-[#2D6A4F]/35 group-hover:border-white/15 group-hover:brightness-110">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 pb-12">
        ...
        <div className="hidden md:block">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-10 mb-8">
            ...
            <div className="lg:col-span-4">
              ...
              <p className="font-sans text-sm text-white/85 leading-relaxed mb-4 max-w-[420px]">
              ...
              <a
                ...
                className="inline-flex flex-col items-start bg-white/[0.05] border border-white/[0.08] rounded-2xl p-3.5 mb-6 select-none transition-all duration-300 ease-out hover:-translate-y-[3px] hover:shadow-[0_10px_30px_rgba(0,0,0,0.18)] cursor-pointer text-left group"
              >
                <div className="flex items-center space-x-0.5 mb-1.5">
                  {[1, 2, 3, 4, 5].map((s) => (
                    <svg key={s} className="w-4 h-4 text-[#D4AF37] transition-transform duration-250 group-hover:scale-110" fill="currentColor" viewBox="0 0 20 20">
              ...
              <div className="flex items-center space-x-5">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-9 h-9 rounded-full bg-white/[0.06] border border-white/[0.08] flex items-center justify-center text-[#D4AF37] hover:text-white hover:bg-[#2D6A4F] hover:border-[#D4AF37] hover:-translate-y-[2px] transition-all duration-250 ease-out group cursor-pointer"
            ...
            <div className="lg:col-span-2">
              <h3 className="font-display font-black text-xs text-[#D4AF37] uppercase tracking-[0.5px] mb-4">
                Quick Links
              </h3>
                ...
                {[
                  ...
                  <li key={item.id}>
                    <button
                      ...
                      className="text-white hover:text-[#D4AF37] transition-all duration-250 block text-left cursor-pointer font-medium relative py-0.5 group md:hover:translate-x-[3px] ease-out"
                    >
                      <span className="relative pb-0.5">
                        {item.label}
                        <span className="absolute bottom-0 left-0 w-0 h-[1.5px] bg-[#D4AF37] transition-all duration-250 ease-out group-hover:w-full" />
                      </span>
                    </button>
                  </li>
                ))}
            ...
            <div className="lg:col-span-3">
              ...
              <ul className="space-y-[19px] font-sans text-sm lg:text-base">
                <li className="flex items-start space-x-3 group">
                  <MapPin className="w-4 h-4 text-[#D4AF37] flex-shrink-0 mt-[4px] transition-all duration-250 group-hover:scale-110" />
                  <a 
                    href="https://maps.google.com/?q=Unitas+Home,+1191K,+Malviya+Colony,+Near+Mahant+Indresh+Hospital,+Dehradun,+Uttarakhand+248001"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-white/85 hover:text-[#D4AF37] transition-all duration-250 text-sm sm:text-base leading-[1.65] font-medium block md:hover:translate-x-[2px]"
                  >
                ...
                <li className="flex items-start space-x-3 group">
                  <Phone className="w-4 h-4 text-[#D4AF37] flex-shrink-0 mt-[4px] transition-all duration-250 group-hover:scale-110" />
                  <a 
                    href="tel:+919675591951" 
                    className="text-white/85 hover:text-[#D4AF37] transition-all duration-250 text-sm sm:text-base font-medium leading-[1.65] block md:hover:translate-x-[2px]"
                  >
                    +91 96755 91951
                  </a>
                </li>
                ...
                <li className="flex items-start space-x-3 group">
                  <Mail className="w-4 h-4 text-[#D4AF37] flex-shrink-0 mt-[4px] transition-all duration-250 group-hover:scale-110" />
                  <a 
                    href="mailto:unitashomeuk@gmail.com" 
                    className="text-white/85 hover:text-[#D4AF37] transition-all duration-250 text-sm sm:text-base font-medium break-all leading-[1.65] block md:hover:translate-x-[2px]"
                  >
        ...
        <div className="block md:hidden pb-0">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <p className="font-sans text-sm text-white/85 leading-relaxed max-w-[420px] mt-4 px-4">
              Premium student co-living in Dehradun with fully furnished rooms, homestyle meals, high-speed Wi-Fi, and 24×7 security.
            </p>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex flex-col items-center bg-white/[0.05] border border-white/[0.08] rounded-2xl p-3.5 mt-5 mb-1 select-none mx-auto transition-all duration-300 ease-out hover:-translate-y-[3px] hover:shadow-[0_10px_30px_rgba(0,0,0,0.18)] cursor-pointer text-center group"
            >
              <div className="flex items-center space-x-0.5 mb-1.5">
                {[1, 2, 3, 4, 5].map((s) => (
                  <svg key={s} className="w-4 h-4 text-[#D4AF37] transition-transform duration-250 group-hover:scale-110" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div className="grid grid-cols-2 gap-x-6 gap-y-[38px] mt-[38px] text-left">
            ...
            <div>
              <h3 className="font-display font-black text-xs text-[#D4AF37] uppercase tracking-[0.5px] mb-[20px]">
                Quick Links
              </h3>
          ...
          <div className="mt-[38px] text-left">
            ...
            <ul className="space-y-[18px] font-sans text-sm sm:text-base">
              <li className="flex items-start space-x-3.5 group">
                <MapPin className="w-4 h-4 text-[#D4AF37] flex-shrink-0 mt-1 transition-transform duration-250 group-hover:scale-110" />
                <a 
                  href="https://maps.google.com/?q=Unitas+Home,+1191K,+Malviya+Colony,+Near+Mahant+Indresh+Hospital,+Dehradun,+Uttarakhand+248001"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-white/85 hover:text-[#D4AF37] transition-all duration-250 leading-snug font-medium block md:hover:translate-x-[2px]"
                >
                  1191K, Malviya Colony, Near Mahant Indresh Hosp, Dehradun – 248001
                </a>
              </li>
              <li className="flex items-center space-x-3.5 group">
                <Phone className="w-4 h-4 text-[#D4AF37] flex-shrink-0 transition-transform duration-250 group-hover:scale-110" />
                <a 
                  href="tel:+919675591951" 
                  className="text-white/85 hover:text-[#D4AF37] transition-all duration-250 font-medium leading-none block md:hover:translate-x-[2px]"
                >
                  +91 96755 91951
                </a>
              </li>
              ...
              <li className="flex items-center space-x-3.5 group">
                <Mail className="w-4 h-4 text-[#D4AF37] flex-shrink-0 transition-transform duration-250 group-hover:scale-110" />
                <a 
                  href="mailto:unitashomeuk@gmail.com" 
                  className="text-white/85 hover:text-[#D4AF37] transition-all duration-250 font-medium break-all leading-none block md:hover:translate-x-[2px]"
                >
                  unitashomeuk@gmail.com
                </a>
              </li>
      ...
      {/* Layered Bottom Copyright Bar (Full width, dark slate green) */}
      <div className="bg-[#153426] border-t border-white/[0.08] relative z-10 py-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          
          {/* Desktop/Tablet Bottom Bar */}
          <div className="hidden md:flex flex-row items-center justify-between font-sans text-xs text-white/70 gap-4">
            ...
            <div className="flex items-center justify-end w-auto space-x-5">
              <div className="flex items-center space-x-3">
                <button 
                  ...
                  className="text-white hover:text-[#D4AF37] transition-colors duration-[250ms] ease-out cursor-pointer font-medium bg-transparent border-0 py-0 px-0 outline-none text-left"
                >
                  House Rules →
                </button>
                ...
                <button 
                  ...
                  className="text-white hover:text-[#D4AF37] transition-colors duration-[250ms] ease-out cursor-pointer font-medium bg-transparent border-0 py-0 px-0 outline-none text-left font-semibold"
                >
                  Terms & Conditions
                </button>
                <span className="text-white/20">•</span>
              ...
              <button
                ...
                className="w-8 h-8 rounded-lg bg-[#2D6A4F] hover:bg-[#1B4332] text-white flex items-center justify-center transition-all duration-[250ms] ease-out cursor-pointer border border-[#2D6A4F]/20"
          ...
          {/* Mobile Bottom Bar */}
          <div className="block md:hidden text-center font-sans text-xs text-white/70 space-y-[18px]">
            {/* Rules & Regulations */}
            <div>
              <button 
                onClick={() => handleLinkClick('rules-regulations')} 
                className="text-white hover:text-[#D4AF37] transition-colors duration-[250ms] ease-out cursor-pointer font-medium bg-transparent border-0 py-0 px-0 outline-none text-center text-xs"
              >
                House Rules →
              </button>
            </div>
            ...
            <div className="flex flex-wrap items-center justify-center gap-x-4 gap-y-2 px-4">
              <button 
                onClick={() => handleLinkClick('terms-of-service')}
                className="text-white hover:text-[#D4AF37] transition-colors duration-[250ms] ease-out cursor-pointer font-medium bg-transparent border-0 py-0 px-0 outline-none text-center text-xs font-semibold"
              >
                Terms & Conditions
              </button>
              <span className="text-white/20">•</span>
            ...
            <div>
              <button
                onClick={handleScrollToTop}
                className="w-8 h-8 rounded-lg bg-[#2D6A4F] hover:bg-[#1B4332] text-white flex items-center justify-center transition-all duration-[250ms] ease-out cursor-pointer mx-auto border border-[#2D6A4F]/20"
                aria-label="Back to Top"
              >
                <ArrowUp className="w-4 h-4" />
              </button>
