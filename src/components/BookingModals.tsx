          ...
          <div className="pt-4 border-t border-[#D4AF37]/25 text-slate-700">
            ...
            <div className="mt-2.5 space-y-2">
              ...
              <a 
                ...
                target="_blank"
                rel="noreferrer"
                className="flex items-center gap-2 text-xs font-semibold hover:text-[#1B4332] transition-colors text-[#2D6A4F]"
              >
                <svg className="w-3.5 h-3.5 fill-[#2D6A4F] text-[#2D6A4F] shrink-0" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
